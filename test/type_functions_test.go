...
func TestArrayObject3(t *testing.T) {
	assertError(t, `parseArray('asd')`, []string{"Error calling function 'parseArray'", "Failed to parse string as a valid JSON", "Unexpected token at line 1, column 0 at #"})
}
...
func TestParseObject3(t *testing.T) {
	assertError(t, `parseObject('asd')`, []string{"Error calling function 'parseObject'", "Failed to parse string as a valid JSON", "Unexpected token at line 1, column 0 at #"})
}
